...
public class BackgroundHandler : MonoBehaviour
{
    ...
    void Update()
    {
        Vector2 diff = new Vector2(mainCamera.transform.position.x - cameraOldPos.x, mainCamera.transform.position.y - cameraOldPos.y);
        cameraOldPos = (Vector2)mainCamera.transform.position;
        //Debug.Log(diff);
